...
public class AufwandsentschaedigungForderungSenden implements JavaDelegate {
	...
	public void execute(DelegateExecution execution) throws Exception {
		...
		System.out.println("Sehr geehrter Kunde,\nWir haben Ihre Bestellung storniert. Aufgrund bisher erfolgter Tätigkeiten erheben wir eine Aufwandsentschädigung in Höhe von 100€. Bitte überweisen Sie uns diesen Betrag unverzüglich.");
